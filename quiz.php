        ...
        <div class="page-content-wrapper">
        	<div class="container">
        		<div class="row">
                    ...
                    <ul>
                    	<li><strong>ጥያቄ ብዛት፡ </strong><?php echo $total;?></li>
                    	<li><strong>ጥያቄ አይነት፡ </strong>ምርጫ</li>
                    	<li><strong>የተፈቀደው ሰአት፡ </strong><?php echo $total * .5; ?> ደቂቃ</li>
                    </ul>
                   <button class="btn"><a href="question.php?n=1" style="text-decoration: none; color: #fff;">ጀምር</a></button>
                   ...
                   <p>
                    ...
                    <ul>
                    	<li><strong>ጥያቄ ብዛት፡ </strong><?php echo $total;?></li>
                    	<li><strong>ጥያቄ አይነት፡ </strong>ምርጫ</li>
                    	<li><strong>የተፈቀደው ሰአት፡ </strong>ያለ ሰአት</li>
                    </ul>
                   <button class="btn"><a href="question2.php?n=1" style="text-decoration: none; color: #fff;">ጀምር</a></button>
